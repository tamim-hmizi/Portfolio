    ...
    >
      ...
      >
        <a
          ...
          className="bg-gray-800 border-2 border-yellow-600/30 p-6 md:p-8 rounded-xl shadow-lg mb-6 hover:border-yellow-500 transition-all cursor-pointer block text-left"
        >
          ...
          <div className="mt-6 space-y-4">
            <div>
              ...
              <div className="text-gray-300 text-sm md:text-base space-y-1">
                ...
                <p>- Data Structures and Algorithms, Database Systems (SQL, NoSQL)</p>
                ...
                <p>- Machine Learning and AI Fundamentals</p>
              </div>
            </div>
