...
const ProfileSection: React.FC = () => {
    ...
    return (
        <section className="min-h-screen flex flex-col items-center justify-center text-center relative overflow-hidden select-none">
            ...
            >
                Software engineering student at Esprit, specializing in cloud computing and DevOps. Passionate about full-stack development, with a focus on creating scalable, efficient, and innovative solutions.
            </motion.p>
